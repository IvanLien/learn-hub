const PORTAL = {
  en: {
    ...
    'mod.17gon.desc': "Animated Carlyle-circle compass-and-straightedge construction of the regular heptadecagon, with full proofs: Gauss's criterion, Galois theory, Gaussian periods, and the explicit cos(2π/17) formula.",
    'mod.17gon.btn': 'Open Module →',
    'mod.linalg.title': 'Linear Algebra Essentials',
    'mod.linalg.sub': 'Vectors · Transforms · Eigenvalues',
    'mod.linalg.desc': 'From 2D vectors to PCA / SVD / PageRank — six draggable demos and seven rigorous proofs. Intuition-first, without sacrificing rigor.',
    'mod.linalg.btn': 'Open Module →',
  ...
  zh: {
    ...
    'mod.17gon.desc': '用 Carlyle 圆方法逐步演示正十七边形的尺规作图，配合高斯判据、伽罗瓦理论与高斯周期的完整数学证明。',
    'mod.17gon.btn': '进入模块 →',
    'mod.linalg.title': '线性代数精要',
    'mod.linalg.sub': '向量 · 变换 · 特征值',
    'mod.linalg.desc': '从二维向量到 PCA / SVD / PageRank，六个可拖拽演示加七篇严格证明，重直觉而不失数学严谨。',
    'mod.linalg.btn': '进入模块 →',
